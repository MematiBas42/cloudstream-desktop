// @PortSource(file = "upstream/app/src/main/java/com/lagradost/cloudstream3/actions/temp/PlayMirrorAction.kt", upstreamCommit = "caeec18")
...
class PlayMirrorAction : VideoClickAction() {
    ...
    override suspend fun runAction(
        ...
        // Implemented a generator to handle the single mirror
        val activity = context as? Activity ?: return
        val link = index?.let { result.links.getOrNull(it) }
