// @PortSource(file = "upstream/app/src/main/java/com/lagradost/cloudstream3/subtitles/AbstractSubProvider.kt", upstreamCommit = "caeec18")
...
class SubtitleResource {
    ...
    suspend fun addZipUrl(
        ...
        val source = app.get(url).okhttpResponse.body?.source()
            ?: throw RuntimeException("Empty response body from $url")
