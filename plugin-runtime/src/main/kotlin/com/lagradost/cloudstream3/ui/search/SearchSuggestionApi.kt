// @PortSource(file = "upstream/app/src/main/java/com/lagradost/cloudstream3/ui/search/SearchSuggestionApi.kt", upstreamCommit = "9feeaedee64b3efc150a3f05df18f955abe170d0")
    ...
    suspend fun getSuggestions(query: String): List<String> {
        ...
        return try {
            val response = app.get(
                ...
                cacheTime = 60 * 24  // Cache for 1 day
            )
