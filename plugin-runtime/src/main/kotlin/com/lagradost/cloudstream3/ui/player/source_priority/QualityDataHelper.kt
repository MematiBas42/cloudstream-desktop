// @PortSource(file = "upstream/app/src/main/java/com/lagradost/cloudstream3/ui/player/source_priority/QualityDataHelper.kt", upstreamCommit = "caeec18")
...
sealed class ProfileSettings<T>(val key: String, val defaultValue: T) {
    data object HideErrorSources : ProfileSettings<Boolean>("hide_error_sources", false)
    data object HideNegativeSources : ProfileSettings<Boolean>("hide_negative_sources", false)
}
