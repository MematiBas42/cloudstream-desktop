// @PortSource(file = "upstream/app/src/main/java/com/lagradost/cloudstream3/ui/WatchType.kt", upstreamCommit = "caeec18")
package com.lagradost.cloudstream3.ui

import com.lagradost.cloudstream3.R

enum class WatchType(val internalId: Int, val stringRes: Int = 0, val iconRes: Int = 0) {
...
enum class SyncWatchType(val internalId: Int, val stringRes: Int = 0, val iconRes: Int = 0) {
