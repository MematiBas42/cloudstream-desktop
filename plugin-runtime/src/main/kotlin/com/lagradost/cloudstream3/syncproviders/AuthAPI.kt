// @PortSource(file = "upstream/app/src/main/java/com/lagradost/cloudstream3/syncproviders/AuthAPI.kt", upstreamCommit = "9feeaedee64b3efc150a3f05df18f955abe170d0")
...
abstract class AuthAPI {
    ...
    fun loginInfo(): LoginInfo? {
        return (this.toRepo() as? SyncRepo)?.authUser()?.let { user ->
            LoginInfo(
