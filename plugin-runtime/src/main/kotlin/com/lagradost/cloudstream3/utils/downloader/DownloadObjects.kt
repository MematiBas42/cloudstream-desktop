// @PortSource(file = "upstream/app/src/main/java/com/lagradost/cloudstream3/utils/downloader/DownloadObjects.kt", upstreamCommit = "caeec18")
...
object DownloadObjects {
    ...
    data class DownloadQueueWrapper(
        @JsonProperty("resumePackage") @SerialName("resumePackage") val resumePackage: DownloadResumePackage? = null,
        @JsonProperty("downloadItem") @SerialName("downloadItem") val downloadItem: DownloadQueueItem? = null,
    ) {
        init {
        ...
        val id: Int = resumePackage?.item?.ep?.id ?: downloadItem!!.episode.id

        @JsonProperty("parentId") @SerialName("parentId")
        val parentId: Int = resumePackage?.item?.ep?.parentId ?: downloadItem!!.episode.parentId
    }
    ...
    data class DownloadedFileInfo(
        ...
        @JsonProperty("basePath") @SerialName("basePath") val basePath: String? = null,
        @JsonProperty("linkHash") @SerialName("linkHash") val linkHash: Int? = null,
    )

    @Serializable
    @SkipSerializationTest
