// @PortSource(file = "upstream/app/src/main/java/com/lagradost/cloudstream3/utils/SubtitleUtils.kt", upstreamCommit = "caeec18")
...
object SubtitleUtils {
    ...
    fun deleteMatchingSubtitles(context: Context, info: DownloadObjects.DownloadedFileInfo) {
        ...
        for (file in folderFiles) {
            ...
            if (!file.delete()) {
                AppLogger.e("SubtitleDeletion", "Failed to delete subtitle file: $name")
            }
        }
    }
