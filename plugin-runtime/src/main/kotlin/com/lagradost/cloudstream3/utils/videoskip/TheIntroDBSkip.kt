// @PortSource(file = "upstream/app/src/main/java/com/lagradost/cloudstream3/utils/videoskip/TheIntroDBSkip.kt", upstreamCommit = "caeec18")
...
class TheIntroDBSkip : SkipAPI() {
    ...
    @Serializable
    data class Root(
        @JsonProperty("tmdb_id") @SerialName("tmdb_id") val tmdbId: Long = 0L,
