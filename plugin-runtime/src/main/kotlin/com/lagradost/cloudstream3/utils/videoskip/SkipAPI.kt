// @PortSource(file = "upstream/app/src/main/java/com/lagradost/cloudstream3/utils/videoskip/SkipAPI.kt", upstreamCommit = "caeec18")
        ...
        suspend fun videoStamps(
            ...
            for (api in skipApis) {
                ...
                return stamps.map { stamp ->
                    ...
                    /** Put in cache */
                    cachedStamps[episode.id] = stampsResult
                }
            }
