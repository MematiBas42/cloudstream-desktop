// @PortSource(file = "upstream/app/src/main/java/com/lagradost/cloudstream3/utils/BackupUtils.kt", upstreamCommit = "caeec18")
...
object BackupUtils {
    ...
    data class BackupVars(
        @JsonProperty("_Bool") @SerialName("_Bool") val bool: Map<String, Boolean>? = null,
        @JsonProperty("_Int") @SerialName("_Int") val int: Map<String, Int>? = null,
        @JsonProperty("_String") @SerialName("_String") val string: Map<String, String>? = null,
        @JsonProperty("_Float") @SerialName("_Float") val float: Map<String, Float>? = null,
        @JsonProperty("_Long") @SerialName("_Long") val long: Map<String, Long>? = null,
        @JsonProperty("_StringSet") @SerialName("_StringSet") val stringSet: Map<String, Set<String>?>? = null,
    )
    ...
    fun getBackup(context: Context): BackupFile {
        val allData = context.getSharedPrefs().getAll().filter { it.key.isTransferable() }
        val allSettings = context.getDefaultSharedPrefs().getAll().filter { it.key.isTransferable() }
    ...
    fun setupBackupStream(context: Context, name: String, ext: String = "txt"): DownloadObjects.StreamData {
        return setupStream(
